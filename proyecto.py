...
total =(f"  $ {sub1 + sub2 + sub3 + sub4 + sub5}")
...
total2 =(f" $ {subf1 + subf2 + subf3 + subf4 + subf5}")
...
print(f"Tu venta total es de: {total2} ")
...
total3 =(f" $ {subh1 + subh2 + subh3 + subh4 + subh5}")
...
print(f"Tu venta total es de: {total3} ")
...
total4 =(f" $ {subi1 + subi2 + subi3 + subi4 + subi5}")
...
print(f"Tu venta total es de: {total4} ")
...
total5 =(f" $ {subj1 + subj2 + subj3 + subj4 + subj5}")
...
print(f"Tu venta total del dia es de: {total5} ")

print(f" ${total} + ${total2} + ${total3} + ${total4} + ${total5} = ${total + total2 + total3 + total4 + total5}")